 ...
 */
FARPROC WINAPI brownian_testDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = brownian_testDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = brownian_testDelayLoadWin32FailureHook;
#endif
